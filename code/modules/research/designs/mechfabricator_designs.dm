...
/datum/design/borg_upgrade_bs_rped
	...
	materials = list(/datum/material/iron =SHEET_MATERIAL_AMOUNT*5, /datum/material/glass =SHEET_MATERIAL_AMOUNT * 2.5, /datum/material/bluespace = SHEET_MATERIAL_AMOUNT * 1)
	construction_time = 120
	category = list(
